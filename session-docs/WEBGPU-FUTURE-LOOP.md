...
- Use `docs/WebGPU-Future/10-IMPLEMENTATION-PROOF-MATRIX.md` as the capability/evidence authority. The first intended `FUTURE-01` proof set is `P-00`, `P-01`, and `P-02`.
...
- Do NOT waive `P-01` with manual browser clicking, screenshots, or weaker substitutes outside the proof matrix.
...
- proof authority: `docs/WebGPU-Future/10-IMPLEMENTATION-PROOF-MATRIX.md` now defines capability claims, artifact expectations, and replay obligations
