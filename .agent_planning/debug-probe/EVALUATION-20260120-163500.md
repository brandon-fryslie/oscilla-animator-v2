...
- CanonicalType available from DebugGraph (compile-time)
...
**Impact**: Probe must render based on CanonicalType (derived from PayloadType + Cardinality), not hardcoded 4.
