...
- `SignalType` extended with optional `unit?: NumericUnit` field (backwards compatible)
- All `signalType*` helpers accept unit parameter
...
**Current Adoption**: 11 usages of `signalType('phase')` across blocks
...
- [x] TimeRoot outputs use `signalType('phase')`
- [x] Oscillator input uses `signalType('phase')`
- [x] Field blocks use `signalType('phase')`
- [x] Runtime kernels documented
- [x] All validations pass

### Sprint 2: Unit Annotations ✅
- [x] NumericUnit type with 8 units
- [x] SignalType optional unit field
...
- [x] SignalType backwards compatible
