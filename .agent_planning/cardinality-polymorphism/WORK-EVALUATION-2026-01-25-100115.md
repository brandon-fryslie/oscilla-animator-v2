...
|-------|-------|----------|--------|--------|
| Pulse | id01, value | canonicalType() | canonicalType('float') | PASS |
| RadiusSqrt | id01, radius, out | canonicalType() | canonicalType('float') | PASS |
| Jitter2D | pos, rand, out | canonicalType() | canonicalType('vec2'/'float') | PASS |
| HueFromPhase | id01, hue | canonicalType() | canonicalType('float') | PASS |
| SetZ | pos, z, out | canonicalType() | canonicalType('vec3'/'float') | PASS |
| FieldPolarToCartesian | angle, radius, pos | canonicalType() | canonicalType('float'/'vec3') | PASS |
| FieldCartesianToPolar | pos, angle, radius | canonicalType() | canonicalType('vec3'/'float') | PASS |
...
- P1: All 7 blocks have correct canonicalType() port types
