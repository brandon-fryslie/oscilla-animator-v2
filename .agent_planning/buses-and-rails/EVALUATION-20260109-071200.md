...
- Canonical 5-axis type system (CanonicalType)
...
**System 2 - New Canonical CanonicalType** (`src/core/canonical-types.ts`):
```typescript
...
**Issue**:
- TimeRoo blocks registered with CanonicalType (canonical)
...
1. **Type System**: CanonicalType vs TypeDesc mismatch blocks full canonical implementation
...
| TimeRoot blocks | 🟡 PARTIAL | 03-time-system | InfiniteTimeRoot                       |
...
| Type system | 🟡 DUAL | 01-type-system | CanonicalType + TypeDesc (not integrated) |
