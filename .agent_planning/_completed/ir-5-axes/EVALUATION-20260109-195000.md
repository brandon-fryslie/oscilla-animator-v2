...
- No axes exposed in IR (SignalType exists but unused)
...
- ✅ SignalType with 5-axis Extent (P0-P3 complete)
...
**SignalType (P0-P3)** contains 5-axis system:
```typescript
...
**Decision Needed**: Bridge SignalType.extent → IR's TypeDesc.axes
...
3. **P2: Expose axes in IR** (blocks type-directed compilation)
   - Bridge SignalType.extent to AxesDescIR
