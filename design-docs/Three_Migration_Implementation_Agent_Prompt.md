...
- [design-docs/Three_Migration_Groundwork_Agent_Prompt.md](/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/design-docs/Three_Migration_Groundwork_Agent_Prompt.md)
...
There is a known baseline typecheck issue in:

- [src/render/webgpu/gpu-api.ts](/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/src/render/webgpu/gpu-api.ts)

`NavigatorWithGpu` currently conflicts with the ambient DOM `GPU` type and breaks `pnpm typecheck` in the current baseline. If your implementation task depends on a green baseline, confirm whether that issue was resolved by groundwork or address it first if your ticket explicitly includes baseline unblocking.
...
- Implement `ThreeForkRenderer` behind [src/render/webgpu/index.ts](/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/src/render/webgpu/index.ts).
...
- Render one chosen patch from [design-docs/DEMO-PATCHES.md](/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/design-docs/DEMO-PATCHES.md).
...
If you created a new design note or migration note, place it under [design-docs](/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/design-docs).
...
Start by reading:
- `/Users/bmf/.codex/worktrees/356b/oscilla-animator-v2/design-docs/Three_Migration_Implementation_Agent_Prompt.md`
