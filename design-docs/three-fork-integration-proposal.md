...
- [three-migration-backend-canon.md](./three-migration-backend-canon.md)
...
- Graph editor and future non-graph authoring UX
  - [src/ui/graphEditor](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/ui/graphEditor)
- Domain concepts
  - instance domains
...
- Patch compilation from user graph to backend-neutral execution plan
  - current seam starts in [src/pillars/compile.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/pillars/compile.ts)
...
- The exported WebGPU renderer is currently a stub in [src/render/webgpu/index.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/render/webgpu/index.ts).
...
- Treat this as legacy reference material, not the long-term center of the architecture.
- Do not restore a dedicated Rust worker runtime as a prerequisite for the Three migration.
...
- [src/graph/Patch.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/graph/Patch.ts)
- [src/ui/graphEditor/types.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/ui/graphEditor/types.ts)
...
The current `ManifestContribution`, `LoweredBundle`, and `LoweredIntent` types in [src/pillars/block-api.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/pillars/block-api.ts) are already oriented toward the current custom renderer contract. That needs to be loosened.
...
Use a simple Pillars patch from [design-docs/DEMO-PATCHES.md](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/design-docs/DEMO-PATCHES.md):
...
2. Implement a new renderer backend behind [src/render/index.ts](/Users/bmf/.codex/worktrees/8bfd/oscilla-animator-v2/src/render/index.ts).
...
- Compile:
  - `compilePillarPatchToLegacyPayload()` still runs
