...
Use `docs/current/webgpu-specs/IMPLEMENTATION-INDEX.md` as the canonical cross-reference map for ABI ownership and execution order.

- Arena/layout ownership: `docs/current/webgpu-specs/P0-1__SoA_Mandate__Memory_Layout_Refactor.md`, `docs/current/webgpu-specs/P1-1__Unified_GPU_Buffer_Strategy_Explained.md`
- Shape header/topology ownership: `docs/current/webgpu-specs/P1-2__Unified_GPU_Shape_Bank_Strategy.md`
- Indirect command ABI ownership: `docs/current/webgpu-specs/P1-3__GPU-Driven_Rendering__Indirect_Buffer.md`
- Draw-prep ownership: `docs/current/webgpu-specs/P3-3_GPU_Draw_Prep__Autonomous_Rendering_Logistics.md`
- Render camera/depth/blend ownership: `docs/current/webgpu-specs/P3-4__WebGPU_Render_Pass_Deep_Dive.md`
...
- **Structure:** Packed `ShapeHeaderV1` records (16 words / 64 bytes) plus payload heap (`u32`), as defined in `docs/current/webgpu-specs/P1-2__Unified_GPU_Shape_Bank_Strategy.md`.
