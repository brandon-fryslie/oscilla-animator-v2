...
See: `docs/current/webgpu-specs/shapes/Shapes 1_ Rigid Stamp_ Technical Implementation Blueprint.md`
...
See: `docs/current/webgpu-specs/shapes/Shapes 2_ The Parametric Curve (Template Instancing).md`
...
See: `docs/current/webgpu-specs/shapes/Shapes 3_ Continuous Ribbon_ Technical Deep Dive.md`
...
See: `docs/current/webgpu-specs/shapes/Shapes 4_ The Procedural Volume (SDFs-Fragment-Driven).md`
...
See: `docs/current/webgpu-specs/shapes/Shapes 5_ Deep Dive_ Text_Glyph Hybrid Rendering.md`
