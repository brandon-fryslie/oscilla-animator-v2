...
Acceptance-proof capability requirements for these phases are centralized in:

- [10-IMPLEMENTATION-PROOF-MATRIX.md](./10-IMPLEMENTATION-PROOF-MATRIX.md)

// [LAW:single-enforcer] Phase sequencing lives here, while proof requirements live once in the proof matrix.
