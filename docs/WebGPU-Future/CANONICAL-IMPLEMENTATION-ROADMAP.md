...
- [CANONICAL-AUTHORING-GUARDRAILS.md](./CANONICAL-AUTHORING-GUARDRAILS.md)
- [CANONICAL-AUTHORING-BLOCK-CATALOG.md](./CANONICAL-AUTHORING-BLOCK-CATALOG.md)
- [CANONICAL-AUTHORING-UI-DESIGN.md](./CANONICAL-AUTHORING-UI-DESIGN.md)
- [CANONICAL-PHYSICS-AUTHORING-DESIGN.md](./CANONICAL-PHYSICS-AUTHORING-DESIGN.md)
...
1. `CANONICAL-RENDER-SINK-DESIGN.md`
2. `CANONICAL-PATCH-STRUCTURE-DESIGN.md`
3. `CANONICAL-AUTHORING-MODEL-DESIGN.md`
4. `CANONICAL-AUTHORING-GUARDRAILS.md`
5. `CANONICAL-AUTHORING-BLOCK-CATALOG.md`
6. `CANONICAL-AUTHORING-UI-DESIGN.md`
7. `CANONICAL-PHYSICS-AUTHORING-DESIGN.md`
...
|---|---|---|---|
| 1 | [CANONICAL-RENDER-SINK-DESIGN.md](./CANONICAL-RENDER-SINK-DESIGN.md) | Defines the scene-to-render boundary | Phase 0 |
| 2 | [CANONICAL-PATCH-STRUCTURE-DESIGN.md](./CANONICAL-PATCH-STRUCTURE-DESIGN.md) | Defines patch strata aligned to the render pipeline | Phase 1 |
| 3 | [CANONICAL-AUTHORING-MODEL-DESIGN.md](./CANONICAL-AUTHORING-MODEL-DESIGN.md) | Defines the finite authoring vocabulary | Phase 2 |
| 4 | [CANONICAL-AUTHORING-GUARDRAILS.md](./CANONICAL-AUTHORING-GUARDRAILS.md) | Defines invariants, boundaries, and extension rules | Phase 2 and Phase 5 |
| 5 | [CANONICAL-AUTHORING-BLOCK-CATALOG.md](./CANONICAL-AUTHORING-BLOCK-CATALOG.md) | Defines the concrete MVP block set and legal graph shapes | Phase 3 |
| 6 | [CANONICAL-AUTHORING-UI-DESIGN.md](./CANONICAL-AUTHORING-UI-DESIGN.md) | Defines appropriate UI workspaces and workflows | Phase 4 and Phase 7 |
| 7 | [CANONICAL-PHYSICS-AUTHORING-DESIGN.md](./CANONICAL-PHYSICS-AUTHORING-DESIGN.md) | Extends the authoring system to simulation-driven animation | Phase 6 |
