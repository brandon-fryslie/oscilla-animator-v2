...
describe('Store Integration', () => {
  it('CompositeEditorStore can export library composite to HCL', async () => {
  ...
  it('CompositeEditorStore can import HCL', async () => {
    const { CompositeEditorStore } = await import('../../stores/CompositeEditorStore');
    const store = new CompositeEditorStore();
  ...
  it('CompositeEditorStore.fromHCL preserves state on error', async () => {
    const { CompositeEditorStore } = await import('../../stores/CompositeEditorStore');
    const store = new CompositeEditorStore();
