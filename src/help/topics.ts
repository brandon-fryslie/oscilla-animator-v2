...
export const HELP_TOPICS: readonly HelpTopic[] = [
  // --- Debug Viz ---
  {
    ...
    duds: [
      ...
      'Broadcast.out — every instance identical, sparkline equals the input',
  ...
  },
  {
    ...
    duds: [
      ...
      'Broadcast.out — all rows identical, solid horizontal bands',
  ...
  },
  {
    ...
    duds: [
      ...
      'Broadcast.out — min=max=mean, zero-width band',
    ],
  },
  {
