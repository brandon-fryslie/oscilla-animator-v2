...
registerBlock({
  ...
  inputs: {
    h: { label: 'Hue', type: canonicalType(FLOAT, unitScalar()), defaultSource: defaultSourceConst(0.0), uiHint: { kind: 'slider', min: 0, max: 1, step: 0.01 } },
    s: { label: 'Saturation', type: canonicalType(FLOAT, unitScalar()), defaultSource: defaultSourceConst(1.0), uiHint: { kind: 'slider', min: 0, max: 1, step: 0.01 } },
    l: { label: 'Lightness', type: canonicalType(FLOAT, unitScalar()), defaultSource: defaultSourceConst(0.5), uiHint: { kind: 'slider', min: 0, max: 1, step: 0.01 } },
    a: { label: 'Alpha', type: canonicalType(FLOAT, unitScalar()), defaultSource: defaultSourceConst(1.0), uiHint: { kind: 'slider', min: 0, max: 1, step: 0.01 } },
  },
  outputs: {
