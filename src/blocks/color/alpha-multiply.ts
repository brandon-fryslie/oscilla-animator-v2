...
import { canonicalType, payloadStride, unitHsl, unitNorm01 } from '../../core/canonical-types';
...
registerBlock({
  ...
  inputs: {
    ...
    alpha: { label: 'Alpha', type: canonicalType(FLOAT, unitNorm01()), defaultSource: defaultSourceConst(1.0) },
  },
  outputs: {
  ...
  lower: ({ ctx, inputsById }) => {
    ...
    const floatType = canonicalType(FLOAT, unitNorm01());
