...
import { register as register_1_make_color_hsl } from './make-color-oklch';
import { register as register_2_split_color_hsl } from './split-color-oklch';
...
import { register as register_6_hsl_to_rgba } from './oklch-to-rgba';
