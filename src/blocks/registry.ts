...
import { FLOAT, INT, BOOL, VEC2, VEC3, VEC4, COLOR, SHAPE, CAMERA_PROJECTION, payloadsEqual } from '../core/canonical-types';
...
export interface AcceptsSpec {
  ...
  /** Extent constraint: 'any' accepts all, 'oneContinuousOnly' requires one+continuous */
  readonly extent: { readonly kind: 'any' } | { readonly kind: 'oneContinuousOnly' };
}
