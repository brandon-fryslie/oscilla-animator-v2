...
impl FnBuilder {
    ...
    pub fn asin(&mut self, a: Expr) -> Expr { self.with_root(|inner| inner.asin(a)) }
    pub fn acos(&mut self, a: Expr) -> Expr { self.with_root(|inner| inner.acos(a)) }
    pub fn atan(&mut self, a: Expr) -> Expr { self.with_root(|inner| inner.atan(a)) }
    pub fn step(&mut self, edge: Expr, x: Expr) -> Expr { self.with_root(|inner| inner.step(edge, x)) }
    pub fn smoothstep(&mut self, lo: Expr, hi: Expr, x: Expr) -> Expr { self.with_root(|inner| inner.smoothstep(lo, hi, x)) }
    pub fn length(&mut self, v: Expr) -> Expr { self.with_root(|inner| inner.length(v)) }
    pub fn distance(&mut self, a: Expr, b: Expr) -> Expr { self.with_root(|inner| inner.distance(a, b)) }
    pub fn dot(&mut self, a: Expr, b: Expr) -> Expr { self.with_root(|inner| inner.dot(a, b)) }
    pub fn cross(&mut self, a: Expr, b: Expr) -> Expr { self.with_root(|inner| inner.cross(a, b)) }
    pub fn normalize(&mut self, v: Expr) -> Expr { self.with_root(|inner| inner.normalize(v)) }
    pub fn reflect(&mut self, i: Expr, n: Expr) -> Expr { self.with_root(|inner| inner.reflect(i, n)) }
    pub fn refract(&mut self, i: Expr, n: Expr, eta: Expr) -> Expr { self.with_root(|inner| inner.refract(i, n, eta)) }
    pub fn swizzle(&mut self, src: Expr, size: naga::VectorSize, pattern: [naga::SwizzleComponent; 4]) -> Expr {
    ...
    pub fn atomic_sub(
        ...
        self.with_root(|inner| inner.atomic_sub(pointer, value, result_type))
    }
    ...
    pub fn atomic_max(
        ...
        self.with_root(|inner| inner.atomic_max(pointer, value, result_type))
    }
    ...
    pub fn atomic_min(
        ...
        self.with_root(|inner| inner.atomic_min(pointer, value, result_type))
    }
    ...
    pub fn atomic_and(
        ...
        self.with_root(|inner| inner.atomic_and(pointer, value, result_type))
    }
    ...
    pub fn atomic_or(
        ...
        self.with_root(|inner| inner.atomic_or(pointer, value, result_type))
    }
    ...
    pub fn atomic_xor(
        ...
        self.with_root(|inner| inner.atomic_xor(pointer, value, result_type))
    }
    ...
    pub fn atomic(
        ...
        self.with_root(|inner| inner.atomic(pointer, fun, value, result_type))
    }

    pub fn dpdx(&mut self, x: Expr) -> Expr {
        self.with_root(|inner| inner.dpdx(x))
    }

    pub fn dpdy(&mut self, x: Expr) -> Expr {
        self.with_root(|inner| inner.dpdy(x))
    }

    pub fn fwidth(&mut self, x: Expr) -> Expr {
        self.with_root(|inner| inner.fwidth(x))
    }
...
impl<'a> FnBodyBuilder<'a> {
    ...
    pub fn atomic_add(
        ...
        self.atomic(pointer, naga::AtomicFunction::Add, value, result_type)
    }
    ...
    pub fn atomic_sub(
        ...
        self.atomic(pointer, naga::AtomicFunction::Subtract, value, result_type)
    }
    ...
    pub fn atomic_max(
        ...
        self.atomic(pointer, naga::AtomicFunction::Max, value, result_type)
    }
    ...
    pub fn atomic_min(
        ...
        self.atomic(pointer, naga::AtomicFunction::Min, value, result_type)
    }
    ...
    pub fn atomic_and(
        ...
        self.atomic(pointer, naga::AtomicFunction::And, value, result_type)
    }
    ...
    pub fn atomic_or(
        ...
        self.atomic(pointer, naga::AtomicFunction::InclusiveOr, value, result_type)
    }
    ...
    pub fn atomic_xor(
        ...
        self.atomic(pointer, naga::AtomicFunction::ExclusiveOr, value, result_type)
    }
