...
impl WorkerObservabilityPacket {
    pub fn to_js_value(self) -> Result<JsValue, JsValue> {
        ...
        set_num(&stage_timings, "totalFrameMs", self.heartbeat.telemetry.total_frame_ms)?;
        js_sys::Reflect::set(&telemetry, &JsValue::from_str("stageTimings"), &stage_timings)?;
        ...
        js_sys::Reflect::set(&telemetry, &JsValue::from_str("dispatchCounters"), &dispatch_counters)?;
        ...
        js_sys::Reflect::set(&telemetry, &JsValue::from_str("resourceStats"), &resource_stats)?;
