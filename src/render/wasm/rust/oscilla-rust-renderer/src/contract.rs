...
#[derive(Debug, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct EnvironmentResizePayload {
    pub width: u32,
    pub height: u32,
}
...
pub enum DispatchMode {
    Domain { #[serde(rename = "domainId")] domain_id: String },
    Texture { #[serde(rename = "textureId")] texture_id: String },
    Exact { x: u32, y: u32, z: u32 },
}
...
pub struct ComputeDependencies {
    ...
    #[serde(default)]
    pub data_streams: HashMap<String, String>,
    #[serde(default)]
    pub textures: HashMap<String, String>,
    #[serde(default)]
    pub samplers: HashMap<String, String>,
}
...
pub enum ExprIR {
    // Primitive literals
    LiteralF32 { value: f64 },
    LiteralU32 { value: u64 },
    LiteralI32 { value: i64 },
    ...
    Swizzle { source: Box<ExprIR>, mask: String },
    IndexAccess { target: Box<ExprIR>, index: Box<ExprIR> },
    // Hardware intrinsics
    ...
    UnaryOp { op: String, expr: Box<ExprIR> },
    // Built-in math
    CallBuiltin { func: String, args: Vec<ExprIR> },
    // Variable reference
    VarRef { name: String },
}
