...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h6ccb53ab42e794c2: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h06ebb0757c7bc899: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__heba5c4c9a966ccbc: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hae70ceb09049e6b9: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h69220e2ced34b20f: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h358697b2f5bc9410: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h59d2ed68b15cc955: (a: number, b: number) => void;
