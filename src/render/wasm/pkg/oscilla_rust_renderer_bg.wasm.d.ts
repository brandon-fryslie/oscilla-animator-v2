...
export const rebuild_with_symbolic_manifest: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
...
export const wasm_bindgen__convert__closures_____invoke__h65696f0a51e234e0_1: (a: number, b: number, c: any) => void;
