...
export interface EnvironmentResizePayload {
...
export interface ComputePassSpec {
  ...
  readonly dependencies: {
    ...
    readonly dataStreams?: Record<StreamId, 'read' | 'read_write'>;
    readonly textures: Record<TextureId, 'read' | 'write' | 'read_write'>;
    readonly samplers?: Record<SamplerId, 'filtering' | 'non_filtering'>;
  };
...
export interface DrawCallSpec {
  ...
  readonly dependencies: {
    ...
    readonly dataStreams?: Record<StreamId, 'read'>;
