    ...
    // Render: same pattern as instanced-write (known working)
    {
      ...
      drawCalls: [{
        ...
        vertexAst: [
          ...
          { type: 'Let', name: 'r', value: { type: 'LoadField', symbolId: 'dots:color_r', index: { type: 'VarRef', name: 'iid' } } },
          { type: 'Let', name: 'g', value: { type: 'LoadField', symbolId: 'dots:color_g', index: { type: 'VarRef', name: 'iid' } } },
          { type: 'Let', name: 'b', value: { type: 'LoadField', symbolId: 'dots:color_b', index: { type: 'VarRef', name: 'iid' } } },
          {
            type: 'ReturnVertex',
            position: {
