 ...
 *
 * WARNING: The FrameHeader struct in these fixtures must match the Rust
 * canonical FrameHeader in memory.rs. This is a known architectural debt —
 * hand-authored WGSL on the JS side has an upward dependency on Rust internals.
 * These fixtures should eventually be generated by or live on the Rust side.
 *
 * The WGSL must match the bind group layout defined in
