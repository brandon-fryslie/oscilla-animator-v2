/**
 * texture-readwrite: Compute writes to a storage texture, render pass samples it.
 * Gate 6+7: Tests texture allocation, TextureStore in compute, TextureSample + sampler in fragment.
 */
        ...
        fragmentAst: [
          {
            ...
            outputs: {
              color: {
                ...
                textureId: 'tex_color',
                samplerId: 'linear',
                uv: { type: 'Swizzle', source: { type: 'VarRef', name: 'uv' }, mask: 'xy' },
              },
            },
          },
        ],
