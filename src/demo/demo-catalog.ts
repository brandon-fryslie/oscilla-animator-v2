...
export const hclDemoCatalog: readonly DemoCatalogEntry[] = [
  ...
  },
  {
    ...
    group: 'features',
    summary: 'Dual feedback vortex — two layers of particles with history-dependent orbits.',
    purposes: ['feature', 'integration', 'showcase'],
    highlights: ['feedback', 'dual feedback loops', 'multi-layer render', 'spiral', 'expression'],
  },
  {
  ...
  },
  {
    ...
    availabilityReason: 'Requires mouse input which is unavailable in preview mode.',
