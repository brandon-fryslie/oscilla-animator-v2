...
export const hclDemoCatalog: readonly DemoCatalogEntry[] = [
  ...
  },
  {
    ...
    group: 'features',
    summary: 'Practical field-variation recipe for stepped and noisy many-lane data.',
    purposes: ['feature', 'integration'],
  ...
  },
  {
    ...
    group: 'integration',
    summary: 'Tight regression patch for field-cardinality generation and jitter shaping.',
    purposes: ['integration'],
