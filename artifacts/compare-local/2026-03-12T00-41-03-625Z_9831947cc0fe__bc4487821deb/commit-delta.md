...
- head: bc4487821deb006ed1944c3fe006e0b483e8055c (bc4487821deb)
- base report generated: 2026-03-12T00:40:36.598Z
- head report generated: 2026-03-12T00:41:03.193Z
- improved metrics: 0
- regressed metrics: 0
- unchanged / informational metrics: 31
- net score (improved - regressed): 0
- changed-file gate: pass (0/60 failing checks across 6 tracked changed files)
...
| src/services/__tests__/compiled-gpu-pass-validation.test.ts | ts-morph max cyclomatic (per file) | n/a | 5 | <= 15 | n/a | pass |
| src/services/__tests__/compiled-gpu-pass-validation.test.ts | ts-morph max cognitive (per file) | n/a | 4 | <= 20 | n/a | pass |
| src/services/__tests__/compiled-gpu-pass-validation.test.ts | ts-morph max nesting depth (per file) | n/a | 1 | <= 4 | n/a | pass |
| src/services/__tests__/compiled-gpu-pass-validation.test.ts | ts-morph average maintainability index (per file) | n/a | 72 | >= 65 | n/a | pass |
...
| src/services/compiled-gpu-pass-validation.ts | ts-morph max cognitive (per file) | n/a | 7 | <= 20 | n/a | pass |
...
| platoAvgHalsteadDifficulty | Plato avg Halstead difficulty | 22 | 23 | +0.053 | 0.23% | regressed | tiny | low |
| platoAvgHalsteadVolume | Plato avg Halstead volume | 2700 | 2700 | +4.3 | 0.16% | regressed | tiny | low |
| platoAvgMaintainability | Plato average maintainability | 69 | 69 | +0.031 | 0.046% | improved | tiny | medium |
| platoMaxCyclomatic | Plato max cyclomatic | 133 | 133 | 0 | 0% | unchanged | none | medium |
| platoTotalLogicalSloc | Plato total logical SLOC | 27881 | 28064 | +183 | 0.66% | unchanged | tiny | low |
| tsMorphAvgMi | ts-morph average maintainability index | 65 | 65 | +0.056 | 0.087% | improved | tiny | high |
...
| tsMorphSourceLocTotal | ts-morph total source LOC | 122752 | 123135 | +383 | 0.31% | unchanged | tiny | low |
| typhonAvgHalsteadDifficulty | Typhon avg Halstead difficulty | 28 | 28 | +0.006 | 0.021% | regressed | tiny | low |
| typhonAvgHalsteadVolume | Typhon avg Halstead volume | 4000 | 4000 | -11 | -0.26% | improved | tiny | low |
| typhonAvgMaintainability | Typhon average maintainability | 63 | 63 | +0.022 | 0.036% | improved | tiny | medium |
| typhonMaxCyclomatic | Typhon max cyclomatic | 284 | 284 | 0 | 0% | unchanged | none | medium |
| typhonTotalLogicalSloc | Typhon total logical SLOC | 84695 | 84997 | +302 | 0.36% | unchanged | tiny | low |
