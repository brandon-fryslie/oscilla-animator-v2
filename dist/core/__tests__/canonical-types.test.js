...
import { axisDefault, axisInstantiated, isInstantiated, getAxisValue, cardinalityZero, cardinalityOne, cardinalityMany, domainRef, temporalityContinuous, temporalityDiscrete, bindingUnbound, bindingWeak, bindingStrong, bindingIdentity, referentRef, extentDefault, extent, signalType, 
// Defaults
DEFAULTS_V0, FRAME_V0, domainDeclFixedCount, domainDeclGrid2d, 
// Unification
unifyAxis, unifyExtent, AxisUnificationError, 
// World mapping
worldToAxes, 
// Derived types
signalTypeSignal, signalTypeField, signalTypeTrigger, signalTypeStatic, } from '../canonical-types';
// =============================================================================
// PayloadType Tests
// =============================================================================
describe('PayloadType', () => {
    it('includes all core payload types', () => {
        const payloads = ['float', 'int', 'vec2', 'color', 'phase', 'bool', 'unit'];
    ...
    it('does NOT include event or domain (these are axis concepts)', () => {
        ...
        const validPayloads = ['float', 'int', 'vec2', 'color', 'phase', 'bool', 'unit'];
