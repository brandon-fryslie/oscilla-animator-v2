...
import { registerBlock, portId, fieldType, } from '../registry';
const lowerFieldRadiusSqrt = ({ b, inputsById }) => {
    ...
    const sqrtId01 = b.fieldMap(id01.id, { kind: 'kernel', name: 'sqrt' }, fieldType('float'));
    ...
    const radiusField = radius.kind === 'sig'
        ...
        : radius.id;
    const effectiveRadius = b.fieldZip([radiusField, sqrtId01], { kind: 'opcode', opcode: OpCode.Mul }, fieldType('float'));
    return {
