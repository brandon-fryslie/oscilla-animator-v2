import { registerBlock, portId, sigType, fieldType, domainType, } from '../registry';
const lowerRenderInstances2D = ({ b, inputsById }) => {
    ...
    if (opacitySigId) {
        finalColorId = b.fieldZipSig(color.id, [opacitySigId], { kind: 'kernel', name: 'applyOpacity' }, fieldType('color'));
    }
