...
const lowerFieldHueFromPhase = ({ b, inputsById }) => {
    ...
    const hue01 = b.fieldZip([phaseField, id01.id], { kind: 'opcode', opcode: OpCode.Add }, fieldType('float'));
    // Wrap hue to 0..1 to handle overflow
    const hue = b.fieldMap(hue01, { kind: 'opcode', opcode: OpCode.Wrap01 }, fieldType('float'));
    return {
