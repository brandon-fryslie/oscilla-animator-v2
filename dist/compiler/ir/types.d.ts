...
export type { NodeIndex, PortIndex, BusIndex, ValueSlot, StepIndex, SigExprId, FieldExprId, EventExprId, TransformChainId, NodeId, BusId, StepId, ExprId, StateId, DomainId, SlotId, } from './Indices';
...
import type { SigExprId, FieldExprId, EventExprId, DomainId } from './Indices';
export type SigExpr = SigExprConst | SigExprSlot | SigExprTime | SigExprExternal | SigExprMap | SigExprZip;
...
export type FieldExpr = FieldExprConst | FieldExprSource | FieldExprBroadcast | FieldExprMap | FieldExprZip | FieldExprZipSig | FieldExprMapIndexed;
...
export type EventExpr = EventExprPulse | EventExprWrap | EventExprCombine;
...
export type Step = StepEvalSig | StepMaterialize | StepRender;
