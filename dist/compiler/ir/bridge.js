 ...
 */
export function extentToAxesDescIR(extent) {
    // Resolve cardinality
 ...
 */
function cardinalityToDomain(cardinality) {
 ...
 */
function temporalityToTemporalityIR(temporality) {
 ...
 */
function perspectiveToIR(perspectiveId) {
 ...
 */
function bindingToIdentity(binding) {
    switch (binding.kind) {
        case 'unbound':
            return { kind: 'none' };
        case 'weak':
 ...
 */
export function payloadTypeToShapeDescIR(payload) {
    switch (payload) {
        case 'float':
            return { kind: 'number' };
        case 'int':
 ...
 */
export function signalTypeToTypeDesc(signalType) {
    return {
